defmodule BrilliantFantasticWeb do
  @moduledoc """
  ...
  def static_paths,
    do: ~w(assets fonts images apple-touch-icon.png favicon.ico robots.txt)
  ...
  def verified_routes do
    quote do
      use Phoenix.VerifiedRoutes,
        ...
        router: BrilliantFantasticWeb.Router,
        statics: BrilliantFantasticWeb.static_paths()
    end
  end
