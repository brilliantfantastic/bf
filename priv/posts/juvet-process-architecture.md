%{
  id: "juvet-process-architecture",
  slug: "juvet-process-architecture",
  title: "Juvet Chronicles",
  author: "Jamie Wright",
  summary: "The Process Architecture",
  date: "2020-11-30",
  published: true,
  tags: []
}
...
![Startup Process Architecture](/images/blog/juvet-process-architecture/start-process-architecture.png)
...
![Valid Configuration Process Architecture](/images/blog/juvet-process-architecture/valid-config-process-architecture.png)
...
![Bot Process Architecture](/images/blog/juvet-process-architecture/bot-process-architecture.png)
...
![Bot with Slack RTM Process Architecture](/images/blog/juvet-process-architecture/bot-with-rtm-process-architecture.png)
