...
3. **Process**: run `mix bf.process_photos`. This generates 480/960/1440/1920px WebP variants in `priv/static/images/photos/{brilliant,fantastic}/`.
4. **Commit** the generated WebP files in `priv/static/images/photos/`. Do NOT commit the originals — `priv/photos_source/` is gitignored.
